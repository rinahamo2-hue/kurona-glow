        ...
        {phase === "ai" && (
          <div className="fade-in">
            <div style={{ textAlign: "center", marginBottom: 32 }}>
              ...
              <h2 style={{ fontSize: 22, fontWeight: 400 }}>あなたの回答を読み解くと</h2>
            </div>

            {aiLoading ? (
              <div style={{ textAlign: "center", padding: "48px 0" }}>
                <div style={{ fontSize: 13, color: "rgba(232,228,220,0.4)", animation: "pulse 1.5s infinite", letterSpacing: "0.1em" }}>
                  分析中…
                </div>
              </div>
            ) : (
              <>
                <div style={{ background: "rgba(232,228,220,0.04)", border: "1px solid rgba(232,228,220,0.1)", borderRadius: 8, padding: "24px", marginBottom: 32 }}>
